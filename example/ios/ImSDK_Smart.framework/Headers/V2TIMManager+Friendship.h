...
/////////////////////////////////////////////////////////////////////////////////
/// 好友搜索字段
typedef NSNumber * V2TIMFriendSearchField;
FOUNDATION_EXPORT V2TIMFriendSearchField const V2TIM_FRIEND_SEARCH_FIELD_USER_ID;       ///< 搜索 userId
FOUNDATION_EXPORT V2TIMFriendSearchField const V2TIM_FRIEND_SEARCH_FIELD_NICK_NAME;     ///< 搜索昵称
FOUNDATION_EXPORT V2TIMFriendSearchField const V2TIM_FRIEND_SEARCH_FIELD_REMARK;        ///< 搜索备注
...
/// 搜索字段列表，支持用户 userID、用户昵称以及好友备注，取值分别为 V2TIM_FRIEND_SEARCH_FIELD_USER_ID，V2TIM_FRIEND_SEARCH_FIELD_NICK_NAME，V2TIM_FRIEND_SEARCH_FIELD_REMARK。
@property(nonatomic, strong) NSArray<V2TIMFriendSearchField> *searchFieldList;
