...
//        }
    ...
    public  static HashMap convertV2TIMUserFullInfoToMap(V2TIMUserFullInfo info){
    ...
    public  static  HashMap convertV2TIMUserInfotoMap(V2TIMUserInfo userInfo){
    ...
    public  static  HashMap convertV2TIMGroupMemberInfoToMap(V2TIMGroupMemberInfo info){
    ...
    public static HashMap convertV2TIMMessageToMap(V2TIMMessage msg,Object ...progress){
        ...
        if(type == V2TIMMessage.V2TIM_ELEM_TYPE_TEXT){
           ...
           final HashMap<String,Object> video = new HashMap<String,Object>();
            ...
            file.put("filePath",fileElem.getPath());
            file.put("fileUUID",fileElem.getUUID());
            ...
            LinkedList<Object> gchangeInfoList = new LinkedList<Object>();
    ...
    public static HashMap convertV2TIMGroupMemberChangeInfoToMap(V2TIMGroupMemberChangeInfo info){
    ...
    public static HashMap convertV2TIMGroupChangeInfoToMap(V2TIMGroupChangeInfo info){
    ...
    public static HashMap convertV2TIMFriendInfoToMap(V2TIMFriendInfo info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendInfoResultToMap(V2TIMFriendInfoResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendOperationResultToMap(V2TIMFriendOperationResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendCheckResultToMap(V2TIMFriendCheckResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendApplicationResultToMap(V2TIMFriendApplicationResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendGroupToMap(V2TIMFriendGroup info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMMessageReceiptToMap(V2TIMMessageReceipt info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMGroupMemberInfoResultToMap(V2TIMGroupMemberInfoResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMGroupMemberFullInfoToMap(V2TIMGroupMemberFullInfo info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
        rinfo.put("userID",info.getUserID ());
    ...
    public static HashMap convertV2TIMGroupMemberOperationResultToMap(V2TIMGroupMemberOperationResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMGroupApplicationResultToMap(V2TIMGroupApplicationResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
        LinkedList<Object> list = new LinkedList<Object>();
    ...
    public static HashMap convertV2TimGroupApplicationToMap(V2TIMGroupApplication info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMFriendApplicationToMap(V2TIMFriendApplication info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
        rinfo.put("userID",info.getUserID());
        rinfo.put("type",info.getType());
        rinfo.put("nickname",info.getNickname());
    ...
    public static HashMap convertV2TIMConversationToMap(V2TIMConversation info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMGroupInfoToMap(V2TIMGroupInfo info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
        ...
        rinfo.put("recvOpt",info.getRecvOpt());
        rinfo.put("role",info.getRole());
        rinfo.put("allMuted",info.isAllMuted());
    ...
    public static HashMap convertV2TIMGroupInfoResultToMap(V2TIMGroupInfoResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
    ...
    public static HashMap convertV2TIMConversationResultToMap(V2TIMConversationResult info){
        HashMap<String,Object> rinfo = new HashMap<String,Object>();
        rinfo.put("nextSeq",info.getNextSeq());
        ...
        for(int i = 0;i<list.size();i++){
            HashMap<String,Object> citem = new HashMap<>();
            V2TIMConversation item = list.get(i);
            citem.put("userID",item.getUserID());
            citem.put("unreadCount",item.getUnreadCount());
            citem.put("type",item.getType());
            citem.put("showName",item.getShowName());
            citem.put("recvOpt",item.getRecvOpt());
            citem.put("lastMessage",CommonUtil.convertV2TIMMessageToMap(item.getLastMessage()));
            citem.put("groupID",item.getGroupID());
            citem.put("faceUrl",item.getFaceUrl());
            citem.put("draftTimestamp",item.getDraftTimestamp());
            citem.put("draftText",item.getDraftText());
            citem.put("conversationID",item.getConversationID());
            clist.add(citem);
        }
