...
public class SignalingManager {
    ...
    public void invite(MethodCall methodCall, final MethodChannel.Result result){
        ...
        String id = V2TIMManager.getSignalingManager().invite(invitee,data,onlineUserOnly,new V2TIMOfflinePushInfo(),timeout,new V2TIMCallback(){
        ...
        CommonUtil.returnSuccess(result,id);
    }
