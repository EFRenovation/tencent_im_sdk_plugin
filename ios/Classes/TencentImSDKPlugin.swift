...
public class TencentImSDKPlugin: NSObject, FlutterPlugin, UNUserNotificationCenterDelegate
{
	...
	*/
	...
	public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
		...
		case "createGroupSimple":
			sdkManager!.createGroupSimple(call: call, result: result)
			break
		// 好友管理 begin
		case "getFriendList":
		...
		case "sendTextMessage":
			messageManager!.sendMessage(call: call, result: result, type: 1)
			break
		case "sendCustomMessage":
			messageManager!.sendMessage(call: call, result: result, type: 2)
			break
		case "sendImageMessage":
			messageManager!.sendMessage(call: call, result: result, type: 3)
			break
		case "sendSoundMessage":
			messageManager!.sendMessage(call: call, result: result, type: 4)
			break
		case "sendVideoMessage":
			messageManager!.sendMessage(call: call, result: result, type: 5)
			break
		case "sendFileMessage":
			messageManager!.sendMessage(call: call, result: result, type: 6)
			break
		case "sendLocationMessage":
			messageManager!.sendMessage(call: call, result: result, type: 7)
			break
		case "sendFaceMessage":
			messageManager!.sendMessage(call: call, result: result, type: 8)
			break
		case "sendGroupTipsMessage":
			messageManager!.sendMessage(call: call, result: result, type: 9)
	...
	* @param params 参数
	*/
	public static func invokeListener(type: ListenerType, method: String, data: Any?) {
