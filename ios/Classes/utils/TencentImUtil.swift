...
public class TencentImUtils {
  ...
  // public static func createTempMessage(msgID: String, succ: succ, fail: fail) -> V2TIMMessage {
  //   let messageType = CommonUtils.getParam(call: call, result: result, param: "messageType") as! Int;
  //   var message: V2TIMMessage = V2TIMMessage()
  //   return (V2TIMManager.sharedInstance()?.createTextMessage(messageMap["text"] as! String))!
  // }

  public static func createMessage(call: FlutterMethodCall, result: @escaping FlutterResult, type: Int) -> V2TIMMessage {
    // let messageMap = CommonUtils.getParam(call: call, result: result, param: "messageMap") as! [String: Any];
	let messageMap = call.arguments as! Dictionary<String, Any>
    var message: V2TIMMessage = V2TIMMessage()
...
//			"/private/var/mobile/Containers/Data/Application/EFAA398E-2A60-40C9-BD32-C95950F0B4C9/tmp/WAVtemporaryRadio.MP3"
